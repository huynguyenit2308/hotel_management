    ...
    <main>
        <section id="room" class="padding-medium">
            <div class="container-fluid padding-side" data-aos="fade-up">
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        <form action="{{ route('bookings.storeOnline') }}" method="POST" class="p-4 bg-light rounded-4">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="room_id" id="room_id" class="form-select @error('room_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($rooms as $room)
                                        <option value="{{ $room->id }}" {{ old('room_id', $room_id) == $room->id ? 'selected' : '' }}>
                            ...
                            @if($selectedRoom)
                                <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
                                    ...
                                    <div class="product-description position-absolute p-5 text-start">
                                        <h4 class="display-6 fw-normal text-white">{{ $selectedRoom->room_type }}</h4>
                                        <table>
                                            <tbody>
                                                <tr class="text-white">
                                                ...
                                                <tr class="text-white">
                                                    ...
                                                    <td class="price">{{ number_format($selectedRoom->price, 0, ',', '.') }} VNĐ /Đêm</td>
                                                </tr>
                                                <tr class="text-white">
