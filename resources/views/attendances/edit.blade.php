        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Sửa thông tin chấm công</h5>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('attendances.update', $attendance->id) }}">
                            ...
                            <div class="col-md-6">
                                <select id="employee_id" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id" required>
                                    ...
                                    @foreach ($employees as $employee)
                                        <option value="{{ $employee->id }}" @if($employee->id == $attendance->employee_id) selected @endif>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="work_date" type="date" class="form-control @error('work_date') is-invalid @enderror" name="work_date" value="{{ old('work_date') ?? $attendance->work_date }}" required>
                                @error('work_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hours_work" type="number" class="form-control @error('hours_work') is-invalid @enderror" name="hours_work" value="{{ old('hours_work') ?? $attendance->hours_work }}" min="0" max="24" step="0.5" required>
                                @error('hours_work')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
