...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/main-logo.png')); ?>">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <ul class="info d-flex flex-wrap list-unstyled m-0">
                        <li class="location text-capitalize d-flex align-items-center me-4" style="font-size: 14px;">
                            ...
                            </svg>53 Võ Văn Ngân, Bình Chiểu, Thủ Đức
                        </li>
        ...
        <nav id="primary-header" class="navbar navbar-expand-lg py-4">
            <div class="container-fluid padding-side">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand <?php echo e(request()->routeIs('home') ? 'active text-warning' : ''); ?>"
                        ...
                        <div class="offcanvas-body align-items-center justify-content-center">
                            <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                                <li class="nav-item px-3">
                                    <a class="nav-link <?php echo e(request()->routeIs('home') ? 'active text-warning' : ''); ?> p-0"
                                        aria-current="page" href="<?php echo e(route('home')); ?>">Trang chủ</a>
                                </li>
                                <li class="nav-item px-3">
                                ...
                                <?php else: ?>
                                    <li class="nav-item px-3">
                                        <a href="<?php echo e(route('login')); ?>"
                                            class="nav-link <?php echo e(request()->routeIs('login') ? 'active text-warning' : ''); ?> p-0">Đăng
                                            nhập</a>
                                    </li>
                                <?php endif; ?>
                                <?php if(Auth::check() &&
                                    ...
                                    <li class="nav-item px-3 dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                                            <li><a href="<?php echo e(route('permissions.index')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('permissions.index', 'permissions.edit') ? 'bg-warning-subtle' : ''); ?>">Phân
                                                    quyền tài khoản</a>
                                            </li>
                                            <li><a href="<?php echo e(route('customers.list')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('customers.list', 'customers.detail', 'customers.edit', 'customers.update') ? 'bg-warning-subtle' : ''); ?>">Khách
                                                    hàng
                                                </a>
                                            </li>
                                            <li><a href="<?php echo e(route('rooms.index')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('rooms.index') ? 'bg-warning-subtle' : ''); ?>">Phòng
                                                </a>
                                            </li>
                                            <li><a href="<?php echo e(route('service.list')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('service.list', ' service.add', 'service.detail', 'service.edit', 'service.search', 'service.price') ? 'bg-warning-subtle' : ''); ?>">Dịch
                                                    vụ </a>
                                            </li>
                                            <li><a href="<?php echo e(route('invoice.list')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('invoice.list', 'invoice.detail') ? 'bg-warning-subtle' : ''); ?>">Hóa
                                                    đơn </a>
                                            </li>
                                            <li><a href="<?php echo e(route('voucher.list')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('voucher.list', 'voucher.add', 'voucher.detail', 'voucher.edit') ? 'bg-warning-subtle' : ''); ?>">Voucher
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo e(route('bookings.index')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('bookings.index', 'bookings.create', 'bookings.createDirect', 'bookings.show', 'bookings.edit') ? 'bg-warning-subtle' : ''); ?>">Các
                                                    phòng đã đặt</a>
                                            </li>
                                            <li><a href="<?php echo e(route('employees.index')); ?>"
                                                    class="dropdown-item <?php echo e(request()->routeIs('employees.index', 'employees.create', 'employees.show', 'employees.edit') ? 'bg-warning-subtle' : ''); ?>">Quản
                                                    lý nhân viên (mới)</a>
                                            </li>
                                            
                                                <li><a href="<?php echo e(route('attendances.index')); ?>"
                                                        class="dropdown-item <?php echo e(request()->routeIs('attendances.index', 'attendances.create', 'attendances.edit', 'attendances.salary_report') ? 'bg-warning-subtle' : ''); ?>">Quản
                                                        lý chấm công</a>
                                                </li>
                                                <li><a href="<?php echo e(route('salaries.index')); ?>"
                                                        class="dropdown-item <?php echo e(request()->routeIs('salaries.index', 'salaries.edit') ? 'bg-warning-subtle' : ''); ?>">Quản
                                                        lý lương</a>
                                                </li>
                                            
                                            <li>
                                            </li>
                                            <li><a href="<?php echo e(route('ratings.list')); ?>" class="dropdown-item">Danh sách
                                                    Đánh
                                                    giá</a>
                                            </li>
                                        </ul>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <?php if(Auth::check()): ?>
                            <a href="<?php echo e(route('profile')); ?>" class="nav-link d-flex align-items-center p-0">
                    ...
                    <div class="cart-icon position-relative">
                        <a href="<?php echo e(route('invoice.list.user')); ?>">
                            ...
                            <span id="cart-count"
                                ...
                                <?php echo e(session('booking_count', 0)); ?>
            ...
            <footer class="row">
                <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item"><a href="<?php echo e(route('home')); ?>" class="p-0 "> Trang chủ </a></li>
                ...
                <div class="col-md-6 col-lg-3 offset-lg-1 mb-4 mb-lg-0">
                    ...
                    <p class="m-0">Trường: Cao Đẳng công nghệ Thủ Đức </p>
                    <p class="m-0">Lớp: Lập trình Back-End Web 2 </p>
                    <p class="m-0">Thực hiện: Nhóm A </p>
                </div>
            </footer>
        </div>
    </footer>
...
<?php /**PATH D:\BE2\hotel_management\resources\views/dashboard.blade.php ENDPATH**/ ?>