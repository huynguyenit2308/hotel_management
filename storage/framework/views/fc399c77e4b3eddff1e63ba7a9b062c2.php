...
unset($__errorArgs, $__bag); ?>"
                                    id="room_number" name="room_number" value="<?php echo e(old('room_number', $room->room_number)); ?>"
                                    required>
...
unset($__errorArgs, $__bag); ?>" id="room_type"
                                    ...
                                    <option value="Standard"
                                        <?php echo e(old('room_type', $room->room_type) == 'Standard' ? 'selected' : ''); ?>>Standard
                                    </option>
                                    <option value="Deluxe"
                                        <?php echo e(old('room_type', $room->room_type) == 'Deluxe' ? 'selected' : ''); ?>>Deluxe
                                    </option>
                                    <option value="Suite"
                                        <?php echo e(old('room_type', $room->room_type) == 'Suite' ? 'selected' : ''); ?>>Suite</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" id="status_id"
                                    ...
                                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($status->id); ?>"
                                            <?php echo e(old('status_id', $room->status_id) == $status->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!--**-->
                            <input type="hidden" name="updated_at" value="<?php echo e($room->updated_at); ?>">
                            <div class="d-flex justify-content-between">
                                <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-secondary">Quay lại</a>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BE2\hotel_management\resources\views/rooms/edit.blade.php ENDPATH**/ ?>