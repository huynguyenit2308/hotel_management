    ...
    <section class="py-5">
        <div class="container">
            ...
            <?php if($invoices->count() > 0): ?>
                <form action="<?php echo e(route('invoice.payment')); ?>" method="GET" id="paymentForm">
                            ...
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                <div class=" d-flex align-items-start gap-5">
                                    ...
                                    <div class="flex-grow-1">
                                        <h3 class="mb-2 fw-bold"><?php echo e($invoice->service->service_name); ?></h3>
                                        <p class="mb-1">Giá:
                                            <span
                                                class="fw-bold"><?php echo e(number_format($invoice->service->price, 0, ',', '.')); ?>

                                                VND</span>
                                        </p>
                                        <p class="mb-1">Ngày đặt:
                                            <?php echo e(\Carbon\Carbon::parse($invoice->create_at)->format('d/m/Y H:i')); ?></p>
                                        <p class="mb-1">Ghi chú: <?php echo e($invoice->note ?? 'Không có ghi chú'); ?></p>
                                        <span class="badge bg-warning"><?php echo e(ucfirst($invoice->status)); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-2 px-2 py-1 rounded" style="min-width: 130px;">
                                    <button type="button"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#cancelModal<?php echo e($invoice->id); ?>"
                                    ...
                                    <div class="form-check m-0">
                                        <input class="form-check-input" type="checkbox" name="invoice_ids[]"
                                            value="<?php echo e($invoice->id); ?>" id="invoice<?php echo e($invoice->id); ?>"
                                            data-price="<?php echo e($invoice->service->price); ?>">
                                    </div>
                                </div>
                            </div>
                ...
                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="modal fade" id="cancelModal<?php echo e($invoice->id); ?>" tabindex="-1"
                        aria-labelledby="cancelModalLabel<?php echo e($invoice->id); ?>" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content rounded-4 shadow">
                                <div class="modal-header bg-danger-subtle text-light rounded-top-4">
                                    <h3 class="modal-title" id="cancelModalLabel<?php echo e($invoice->id); ?>">Xác nhận hủy</h3>
                                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    Bạn có chắc chắn muốn hủy dịch vụ
                                    <strong><?php echo e($invoice->service->service_name); ?></strong>?
                                </div>
                                <div class="modal-footer d-flex gap-2 justify-content-end">
                                    <form action="<?php echo e(route('invoice.cancel.user', ['id' => $invoice->id])); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit"
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BE2\hotel_management\resources\views/userService/listInvoiceUser.blade.php ENDPATH**/ ?>