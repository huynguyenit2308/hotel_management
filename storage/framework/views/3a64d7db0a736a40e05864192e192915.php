    ...
    <section id="services" class="py-5">
        <div class="container-fluid padding-side" data-aos="fade-up">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <form action="<?php echo e(route('service.search')); ?>" method="GET" class="position-relative">
                    ...
                    <?php $__currentLoopData = $service; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6 col-xl-4">
                            <div class="service mb-4 text-center rounded-4 p-5">
                                <h4 class="display-6 fw-normal my-3"><?php echo e($value->service_name); ?></h4>
                                <a href="<?php echo e(route('service.detail', ['id' => $value->encoded_id])); ?>" class="btn btn-arrow">
        ...
        <div class="d-flex justify-content-center mt-4">
            <div class="pagination-wrapper">
                <?php echo e($service->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BE2\hotel_management\resources\views/crud_service/list.blade.php ENDPATH**/ ?>